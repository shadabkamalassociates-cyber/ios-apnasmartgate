    ...
    <View style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.75}
          onPress={() => {
            closeThen(() => navigation.navigate('CreateTicket', { kind: 'user' }));
          }}
        >
          <View style={styles.rowLeft}>
            <View style={styles.rowIcon}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            ...
            if (!email) {
              Alert.alert(
                'Email required',
                'Add an email to your profile first, then request a password reset.'
              );
              return;
            }
              ...
              { text: 'Cancel', style: 'cancel' },
              {
                ...
                onPress: async () => {
                  try {
                    ...
                    Alert.alert('Check your email', res.message || 'Password reset email sent.');
                  } catch (e: any) {
                    const msg =
        ...
        >
          <View style={styles.rowLeft}>
            <View style={[styles.rowIcon, styles.rowIconDanger]}>
              {deleting ? (
                <ActivityIndicator size="small" color="#C14F2C" />
              ) : (
                <Ionicons name="trash-outline" size={18} color="#C14F2C" />
              )}
            </View>
