          ...
          <Pressable style={styles.sheetCard} onPress={() => {}}>
            ...
            {menuPost && canEditOrDelete(menuPost) ? (
              ...
              <>
                  ...
                  onPress={() => {
                    ...
                    if (navigationRef.isReady()) {
                      navigationRef.navigate('CreateTicket', {
                        ...
                        prefillDescription: [
                          `Post ID: ${p.id}`,
                          p.createdByResident != null ? `Posted by resident: ${p.createdByResident}` : null,
                          p.createdByOwner != null ? `Posted by owner: ${p.createdByOwner}` : null,
                          p.description ? `Content: ${p.description}` : null,
                        ]
                          .filter(Boolean)
                          .join('\n'),
                      });
                ...
                <Text style={styles.sheetHint}>You can only edit or delete your own posts.</Text>
              </>
            ) : (
